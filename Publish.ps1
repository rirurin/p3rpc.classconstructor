...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "p3rpc.classconstructor/p3rpc.classconstructor.csproj",
    $PackageName = "p3rpc.classconstructor",
    ...
    $NuGetPackageId = "p3rpc.classconstructor",
...
# Publish interface
$InterfaceProjectPath = "p3rpc.classconstructor.Interfaces/p3rpc.classconstructor.Interfaces.csproj"
